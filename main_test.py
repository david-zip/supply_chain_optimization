...
def test_run(args):
    ...
    """
    SC_params_ = {'echelon_storage_cost':(5/2,10/2,7/2), 'echelon_storage_cap' :(20,7,10),
                    'echelon_prod_cost' :(0,0,0), 'echelon_prod_wt' :((5,1),(7,1),(9,1)),
                    'material_cost':{0:12}, 'product_cost':{0:100}}
    n_echelons_ = 3
    ...
    for arg in args:
        best_policy, best_reward, R_list = algo_dict[arg].algorithm(function=J_supply_chain_ssa_seasonality, SC_run_params=SC_run_params_, iter_debug=True)
