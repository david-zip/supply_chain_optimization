...
def evaluate(args, **kwargs):
    """
    Runs the trained parameters in the environemnt to evaluate performance
    
    keywords['demand']   = demand function
    ...
    SC_run_params_['demand_f']   = kwargs['demand']
    ...
    for step_k in range(steps_tot):
        ...
        demand_history[step_k]         = kwargs['demand'](*df_params)
